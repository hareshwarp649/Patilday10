...
namespace LibraryAddressbook
{
    internal class AddContact
    {
        ...
        public static List<ContactFull> b;
        ...
        public static void AddressBook()
        {
            ...
            {
                mySystem[addressBookName] = new List<ContactFull>();
                NewContact(addressBookName);
            }
        }
        public static void AddressBookNew()
        {
